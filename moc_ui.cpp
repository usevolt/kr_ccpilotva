...
QT_MOC_LITERAL(1, 3, 9), // "statusLog"
QT_MOC_LITERAL(2, 13, 0), // ""
QT_MOC_LITERAL(3, 14, 3) // "str"

    },
    "Ui\0statusLog\0\0str"
};
...
void Ui::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->statusLog((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (Ui::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Ui::statusLog)) {
                *result = 0;
                return;
            }
        }
